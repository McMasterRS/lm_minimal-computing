...
**a. Create a new folder named "_data".**
...
**a. Create a new folder named "_includes".**

**b. In the _includes folder, create a file named "nav.html".**
...
**a. In the custom.scss file add the code below to customize your navbar stylesheet.**
```ts
.site-nav {
    padding: 0;
